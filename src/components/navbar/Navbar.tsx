...
const Navbar: React.FC = () => {
  ...
  return (
    <div className='w-full lg:p-4 flex fixed top-0 left-0 z-50 justify-center items-center border-b-2 '>
      <div className='w-full flex lg:space-x-8 justify-center items-center'>
      ...
      <div className='w-full flex justify-center items-center text-md font-serif lg:space-x-12'>
        ...
        <Link to={'/sign-up'} className='text-sky-600 border border-sky-600 p-3 w-28 flex text-center items-center justify-center rounded-2xl hover:bg-sky-600 hover:text-white ease-in-out duration-500'>
          Sign up
        </Link>
      </div>
    </div>
