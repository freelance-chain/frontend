    ...
    return (
        <div className='w-full flex justify-center items-center lg:p-4'>
            <div className='w-11/12 lg:w-3/4 flex flex-col justify-center items-center bg-sky-600 rounded-xl'>
                <div className='mt-12 lg:p-8 text-center'>
                    <h1 className='text-white lg:text-5xl text-xl'> Find the perfect <strong className='text-blue-800'>freelancers</strong> / <strong className='text-blue-800'> projects </strong> in just a few clicks </h1>
                </div>
                <div className='lg:mt-8 mb-8 mt-8 flex justify-center items-center'>
